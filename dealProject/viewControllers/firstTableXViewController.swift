//
//  firstTableXViewController.swift
//  dealProject
//
...
class firstTableXViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cellX = tableView.dequeueReusableCell(withIdentifier: "cellIdentifierX1", for: indexPath) as! firstTableViewCell
        
        cellX.labelX1.text = name [indexPath.row]
        
        cellX.labelX2.text = idDeal [indexPath.row]
